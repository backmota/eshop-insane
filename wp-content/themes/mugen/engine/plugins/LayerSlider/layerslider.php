...
/********************************************************/
	...
	define('LS_ROOT_PATH', THE_ENGINEPATH.'plugins/LayerSlider/' );
	define('LS_ROOT_URL', THE_ENGINEURI.'plugins/LayerSlider/' );
	define('LS_PLUGIN_VERSION', '5.0.2');
	define('LS_PLUGIN_SLUG', basename( THE_ENGINEPATH.'plugins/LayerSlider/' ));
	define('LS_PLUGIN_BASE', LS_PLUGIN_SLUG.'/layerslider.php');

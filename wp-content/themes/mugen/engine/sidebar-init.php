...
function if_sidebar_init() {
	...
	/* FOOTER UPPER */
	register_sidebar(array(
		'name'          => __('Footer Upper 1 Sidebar', THE_LANG ),
		'id'         	=> 'footerupper1',
	...
	register_sidebar(array(
		'name'          => __('Footer Upper 2 Sidebar', THE_LANG ),
		'id'         	=> 'footerupper2',
	...
	register_sidebar(array(
		'name'          => __('Footer Upper 3 Sidebar', THE_LANG ),
		'id'         	=> 'footerupper3',
	...
	register_sidebar(array(
		'name'          => __('Footer Upper 4 Sidebar', THE_LANG ),
		'id'         	=> 'footerupper4',
	...
	/* FOOTER */
	register_sidebar(array(
		'name'          => __('Footer 1 Sidebar', THE_LANG ),
		'id'         	=> 'footer1',
		'description'   => __( 'Located at the footer column 1.', THE_LANG ),
		'before_widget' => '<div class="widget-bottom"><ul><li id="%1$s" class="widget-container %2$s">',
		'after_widget' 	=> '</li></ul></div>',
	...
	register_sidebar(array(
		'name'          => __('Footer 2 Sidebar', THE_LANG ),
		'id'         	=> 'footer2',
		'description'   => __( 'Located at the footer column 2.', THE_LANG ),
		'before_widget' => '<div class="widget-bottom"><ul><li id="%1$s" class="widget-container %2$s">',
		'after_widget' 	=> '</li></ul></div>',
	...
	register_sidebar(array(
		'name'          => __('Footer 3 Sidebar', THE_LANG ),
		'id'         	=> 'footer3',
		'description'   => __( 'Located at the footer column 3.', THE_LANG ),
		'before_widget' => '<div class="widget-bottom"><ul><li id="%1$s" class="widget-container %2$s">',
		'after_widget' 	=> '</li></ul></div>',
	...
	register_sidebar(array(
		'name'          => __('Footer 4 Sidebar', THE_LANG ),
		'id'         	=> 'footer4',
		'description'   => __( 'Located at the footer column 4.', THE_LANG ),
		'before_widget' => '<div class="widget-bottom"><ul><li id="%1$s" class="widget-container %2$s">',
		'after_widget' 	=> '</li></ul></div>',

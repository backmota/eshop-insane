...
function optionsframework_options() {
	...
	$options[] = array( 'name' => __('Sidebar Position', THE_LANG),
		...
		'std' => 'two-col-left',
		'type' => 'images',
		'options' => $optmainlayout
	);
	
	$options[] = array( 'name' => __('Footer Upper Sidebar Layout', THE_LANG),
		'desc' => __('Select footer upper sidebar layout. Default sidebar is four column.', THE_LANG),
		'id' => $shortname."_footer_upper_sidebar_layout",
		'std' => '9',
		'type' => 'images',
		'options' => $optfooterlayout
	);
	...
	$options[] = array( 'name' => __('Container\'s Width', THE_LANG),
		'desc' => __('Set the length of your container\'s width between 960px - 1140px', THE_LANG),
		'id' => $shortname."_container_width",
		'std' => '960',
		'class' => 'mini',
		'type' => 'text');
	
	$options[] = array( 'name' => __('Boxed style?', THE_LANG),
		'desc' => __('Select this checkbox to use boxed style on your theme.', THE_LANG),
		'id' => $shortname."_boxed_style",
		'std' => '0',
		'type' => 'checkbox');
	...
	$options[] = array( 'name' => __('General Fonts', THE_LANG),
		...
		'std' => 'Arimo:regular|italic|700|700italic',
		'type' => 'select',
	...
	$options[] = array( 'name' => __('Disable Minicart', THE_LANG),
		'desc' => __('Select this checkbox to disable minicart at the top.', THE_LANG),
		'id' => $shortname."_disable_minicart",
		'std' => '0',
		'type' => 'checkbox');
	
	$options[] = array( 'name' => __('Disable Top Product Categories', THE_LANG),
		'desc' => __('Select this checkbox to disable product categories at the top.', THE_LANG),
		'id' => $shortname."_disable_toppcats",
		'std' => '0',
		'type' => 'checkbox');
